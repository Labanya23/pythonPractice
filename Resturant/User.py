...
class User(ABC):
    def def__init__(self, name, phone, email, address) -> None:
        self.name = name
        self.phone = phone
        self.email = email
...
class Customer(User):
    ...
    def place_order(self,order):
        ...
        print(f'{self.name} placed an order with bill{order.items}')

    def eat_food(self,order):
        print(f'{self.name} item food')
...
class Chef(Employee):
    def __init__(selfself,name,phone,email,address,
                 salary,starting_date,department,cooking_item) -> None:
        super().__init__(name,phone,email,address,salary,
                         starting_date,department)
        self.cooking_item = cooking_item

class Server(Employee):
    def __init__(self, name, phone, email, address, salary,
                 starting_date,department) ->None:
        self.tips_earning = 0
        super().__init__(name,phone,email,address,salary,
                         starting_date,department)
...
class Manager(Employee):
    def __init__(selfself,anme,phone,email,address,
                 salary,starting_date) ->None:
        super().__init__(name,phone,email,address,
